...
def write_terminal_latex_tables(summary: list[dict[str, float]]) -> None:
    ...
    lines = [
        ...
        r"\centering",
        r"\scriptsize",
        r"\caption{Wariant centralny: metryki firmowe i rynku pracy dla 10 ziaren losowania}",
    ...
    lines.extend(
        [
            ...
            r"\centering",
            r"\scriptsize",
            r"\caption{Wariant centralny: metryki makro-fiskalne dla 10 ziaren losowania}",
