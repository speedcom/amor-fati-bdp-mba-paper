...
Tabela~\ref{tab:claim-status} porządkuje status twierdzeń: model odrzuca hipotezę monotoniczną i wspiera wersję warunkową, zależną od zdolności firm do finansowania reakcji technologicznej.
