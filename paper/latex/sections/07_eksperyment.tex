...
\begin{equation}
  \mathrm{Transfer}_h = \mathrm{Children}_h \cdot 800 + BDP.
\end{equation}

Kanał płacy rezerwowej zapisano jako:
\begin{equation}
  \mathrm{ReservationWage} = \mathrm{MinWage} + \lambda \cdot BDP.
\end{equation}
