...
\centering
\scriptsize
\caption{Wariant centralny: metryki firmowe i rynku pracy po 10 ziarnach losowania}
\label{tab:terminal-results-real}
\begin{tabular}{@{}rccc@{}}
\toprule
BDP & AI/hybrid & Inwestycje/PKB & Bezrobocie \\
PLN/mies. & \multicolumn{3}{c}{średnia \(\pm\) odch. std. między ziarnami, \%} \\
\midrule
...
\centering
\scriptsize
\caption{Wariant centralny: metryki makro-fiskalne po 10 ziarnach losowania}
\label{tab:terminal-results-macro}
\begin{tabular}{@{}rcccc@{}}
\toprule
BDP & Inflacja & Stopa NBP & Dług/PKB & Deficyt/PKB \\
PLN/mies. & \multicolumn{4}{c}{średnia \(\pm\) odch. std. między ziarnami, \%} \\
\midrule
