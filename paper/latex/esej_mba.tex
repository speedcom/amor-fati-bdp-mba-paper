...
\medskip
\noindent\textbf{Ujawnienie:} Silnik modelu \amor{} jest autorskim projektem open-source autora pracy, rozwijanym w ramach \bbg{}. Patch scenariusza BDP, dane Monte Carlo i skrypty replikacyjne są wydzielone do osobnego repozytorium pracy \paperrepo{}.

\medskip
\noindent\textbf{Kod i dane:} silnik modelu \amor{}; artefakty pracy, dane Monte Carlo i patch BDP w repozytorium \paperrepo{}.
\newline
